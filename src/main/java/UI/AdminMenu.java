...
public class AdminMenu implements Menu {
    ...
    public AdminMenu(Scanner input, VehicleOwnerController ownerController, VehicleController vehicleController) {
        this.input = input;
    ...
    public void show(UserRole role) {
        ...
        while (true) {
            ...
            System.out.println("2.  Deactivate Vehicle Owner");
            System.out.println("3.  Activate  Vehicle Owner");
